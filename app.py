...
get_ipython().system('pip install -q pyngrok streamlit networkx matplotlib numpy pandas torch plotly')
...
get_ipython().system('pkill -f streamlit || true')
get_ipython().system('pkill -f ngrok || true')
try:
...
time.sleep(5)
ngrok_process = subprocess.Popen(["ngrok","http","--domain=aiwargame.ngrok.app","8501"])
